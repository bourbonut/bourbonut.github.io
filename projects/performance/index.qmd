...
<input id="python-button" type="button" value="Python" onclick="select_language('python');"></input>
<input id="rust-button" type="button" value="Rust" onclick="select_language('rust');"></input>
<input id="cpp-button" type="button" value="C++" onclick="select_language('cpp');"></input>
<input id="elixir-button" type="button" value="Elixir" onclick="select_language('elixir');"></input>
<input id="java-button" type="button" value="Java" onclick="select_language('java');"></input>
<input id="lua-button" type="button" value="Lua" onclick="select_language('lua');"></input>
<input id="javascript-button" type="button" value="Javascript" onclick="select_language('javascript');"></input>
<input id="scala-button" type="button" value="Scala" onclick="select_language('scala');"></input>
